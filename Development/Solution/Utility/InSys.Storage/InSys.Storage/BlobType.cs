...
namespace InSys.Storage
{
    ...
    public class BlobContentType : Dictionary<string, string>
    {
        public BlobContentType()
        {
        ...
        public string GetBlobContentType(string Extension, string AlternateExtension = "")
        {
