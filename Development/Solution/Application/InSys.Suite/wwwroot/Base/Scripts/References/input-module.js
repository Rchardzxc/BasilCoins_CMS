            ...
            if (_.options.type == 'date' || _.options.type == 'time' || _.options.type == 'datetime') {
                ...
                _.$elem.on("keydown", function (e) {
                    if (_.options.type == "date") {
                        ...
                        if (!result && !(e.keyCode == 8) && !(e.keyCode == 9) && !(e.keyCode == 37) && !(e.keyCode == 39)) {
                            e.preventDefault();
                        }
                    } else if (_.options.type == "time") {
                        var pattern = new RegExp("[0-9.:AMPMampmAmPmaMpM ]");
                        var result = pattern.test(e.key);
                    ...
                    if (_.options.type == 'alphabet') {
                        ...
                        if (!result && !(e.keyCode == 8) && !(e.keyCode == 9) && !(e.keyCode == 37) && !(e.keyCode == 39)) {
                            ...
                            if (_.$elem.val().indexOf(".") > -1) {
                                ...
                                if (selectedLength == 0) {
                                    if ((l > (_.options.decimalPlace - 1)) && !(e.keyCode == 8) && !(e.keyCode == 9) && !(e.keyCode == 37) && !(e.keyCode == 39)) {
                                        e.preventDefault();
                                    }
                                }
                            }
